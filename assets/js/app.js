  ...
  */
  ...
  (() => {
    ...
    companiesList.forEach(company => {
      ...
      const mobileDescription = document.querySelector(`.company-description.${company.dataset.target}`).cloneNode(true)
      // It's hidden by default, will be visible on small devices via CSS
      mobileDescription.style.display = 'none'
      // Make it distinguishable from the description shown in large devices
      mobileDescription.classList.add('-mobile')
      mobileDescription.classList.remove('-desktop')
      // Insert the element before the end of the company list item
      company.insertAdjacentElement('beforeend', mobileDescription)
      ...
      company.addEventListener('click', function () {
        ...
        document.querySelector('.companies-illustration').style.display = 'none'
